...
* **12 Dungeon Chamber Types**: Full support for standard *DungeonQuest* chamber types (Dungeon Rooms, Bottomless Pits, Catacomb Entrances, Trap Rooms, Chambers of Darkness, Treasure Chambers, Corridors, Chasms, Cave-ins, Bridges, and Rotating Rooms).
